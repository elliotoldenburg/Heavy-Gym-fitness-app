      ...
      <ScrollView style={styles.container} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.successContainer}>
            <CheckCircle2 size={64} color="#4CAF50" style={styles.successIcon} />
            <Text style={styles.successTitle}>Konto skapat!</Text>
            <Text style={styles.successDescription}>
              Vi har skickat ett verifieringsmail till {email}. Klicka på länken i mailet för att verifiera ditt konto och börja din träningsresa.
            </Text>
            <Text style={styles.successNote}>
              Kontrollera din skräppost om du inte hittar mailet inom några minuter.
            </Text>
          </View>
          ...
          <Link href="/login" asChild>
            <Pressable style={styles.loginLink}>
              <Text style={styles.loginLinkText}>
                Gå till <Text style={styles.loginLinkHighlight}>inloggning</Text>
              </Text>
            </Pressable>
          </Link>
        </View>
